...
int main()
{
  ...
  while(b1 != EOF)
  {
    ...
    else if(b1 >> 5 == 0x06)
    {
      ...
      else if(b2 >> 6 != 0x02) //invalid format on second part of multi-byte UTF-8
      {
    ...
    else if(b1 >> 4 == 0x0E)
    {
      ...
      {
        //else if ensures that byte 3 is skipped and process is resumed on byte 4
