...
public class Regex
{
   ...
   {  
      if ( regex != null && regex.length() > 0 )
      {
        ...
        _flags = Pattern.MULTILINE;
         _pattern = Pattern.compile(regex, _flags);
         if(_testInput != null)
         {
           _matcher = _pattern.matcher(_testInput);
         }
   ...
   public void setInput( String testString )
   {
      ...
      if ( _pattern != null && testString != null )
      {
         ...
         /////////////////////////////////////////////////////////
         Matcher match = _pattern.matcher(testString);
         _matcher = match;
   ...
   public String split()
   {
      ...
      else
      {
         ...
         ///////////////////////////////////////////////////////////// 
         String[] matches = _pattern.split(_testInput);
