...
public class Teller extends Thread
{
   ...
   public void run()
   {
      ...
      while ( !_shuttingDown || _clientsIn.size() > 0 )
      {
         synchronized( _clientsIn)
         {
           while(_clientsIn.size() == 0 && !_shuttingDown)
           {
             System.out.println(_name + " is waiting.");
             try
             {
               _clientsIn.wait();
             }
             ...
             {
             System.err.println(_name + " was interrupted");
             }
           }
