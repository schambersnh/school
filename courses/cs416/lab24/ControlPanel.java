...
public class ControlPanel extends JPanel 
{
   ...
   public ControlPanel( Component parent, TreeApp app ) 
   {
      ...
      //buttonRow.add( new AllowDuplicatesCheckBox() );
   ...
   //+++++++++++++++++++++++ AllowDuplicatesCheckBox class ++++++++++++++++++++
   /**
    * private inner class to update the child size ratio with a slider
    */
   private class AllowDuplicatesCheckBox extends ParameterCheckBox 
   {
      //---------------- constructor --------------------------------------
      public AllowDuplicatesCheckBox () 
      {
         super( "Allow duplicate keys", false );
      }
      //------------------- valueChanged( int ) -----------------------
      public void valueChanged( boolean newValue ) 
      {
         _app.setDuplicates( newValue );
      }
   }
}
