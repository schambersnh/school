...
public class CardStack extends Stack<Card> implements CardGroup
{
    ...
    public CardStack( JPanel parent, int x, int y )
    {
        ...
        _empty = new JLabel();
        _empty.setSize( Card.width, Card.height );
        _empty.setLocation( _xLoc, _yLoc );
        _empty.setBorder( new LineBorder( Color.BLACK, 1  ) );
        _empty.setText("  Empty" );
        _empty.setOpaque(true);
        _empty.setBackground( Color.LIGHT_GRAY );
        _parent.add(_empty);
    }
