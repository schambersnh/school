...
public class TreeApp
{
  ...
  //---------------------- height() -----------------------------
   ...
   //---------------------- setBalance() -----------------------------
   /**
    * set the value field of each node to be the abs( leftCount - rightCount )
    */
