/** 
 * @author Stephen Chambers for Lab3 on 2/3/2011
 * modified from BouncingBall.java
 */
import java.awt.*;
import java.awt.geom.*;
import javax.swing.*;

public class JBouncingBall extends JEllipse implements Animated 
{
   //----------------- instance variables ---------------------
   ...
   //------------------ constructor ---------------------------
   public JBouncingBall( Container aPanel, Color aColor )
   {
      super( aColor );
      setMove( 8, 8 );
      _parent   = aPanel;
