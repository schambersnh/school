...
public class GUI extends JPanel 
{
   ...
   private static JLabel  findCountLabel;
   ...
   //-------------- makeFindCountLabel() --------------------------
   private Component makeFindCountLabel()
   {
      JPanel labelPanel = new JPanel();
      
      labelPanel.add( new JLabel( "Find Count: " ));
      findCountLabel = new JLabel( "      " );
      findCountLabel.setFont( getFont().deriveFont( 12.0f )); // make the font big

      findCountLabel.setBorder( new LineBorder( Color.BLACK ));
      labelPanel.add( findCountLabel );
   ...
   //--------------------- setFindCountLabel( String ) ----------------------
   /**
    * update the label field showing the current regular expression
    */
   public static void setFindCountLabel( String newText )
   {
      findCountLabel.setText( "  " + newText + "  " );
   }
   //------------------- makeButtonMenu --------------------------------
   ...
   {
      RESET r = new RESET( "Regular Expression Simple Exploration Tool", args );
   }
}
