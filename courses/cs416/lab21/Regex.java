...
public class Regex
{
   ...
   {  
      ...
      {
         //////////////////////////////////////////////////////////////
         // as long as the argument is not null and has length > 0
         //   create a pattern object from the string, using
         //   the "compile" static method of Pattern. 
         //   The first argument to Pattern.compile is the regex string,
         //   The 2nd argument must be Pattern.MULTILINE.
         ...
         //       squashed all of the lines of the input into a singe String
         //       for convenience.
   ...
   {  
      //////////////////////////////////////////////////////////////
      // Just need to return the results from calling the 
   ...
   //---------------------- reset() -----------------------------
   /**
    * reset the regular expression processng on the current input string.
