/**
 * ZTetromino.java
 * Creates a Z Tetromino used in the game of Tetris
 * 
 * Stephen Chambers
 * 11/23/10
 */ 
...
public class ZTetromino implements Tetromino
{
  ...
  {    
    ...
    Configuration zConfigUp = new Configuration( 0, 0, 0, 1, 1, 1, 1, 2 );
    Configuration zConfigLeft = new Configuration( 0, 2, 1, 1, 1, 2, 2, 1 );
    Configuration zConfigRight = new Configuration( 0, 0, 0, 1, 1, 1, 1, 2 );
    Configuration zConfigDown = new Configuration( 0, 2, 1, 1, 1, 2, 2, 1 );
    
    //adds configurations
    config.add( zConfigUp );
    config.add( zConfigLeft );
    config.add( zConfigRight );
    config.add( zConfigDown );
