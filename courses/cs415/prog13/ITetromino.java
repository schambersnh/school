/**
 * ITetromino.java
 * Creates a I Tetromino used in the game of Tetris
 * 
 * Stephen Chambers
 * 11/23/10
 */ 
...
public class ITetromino implements Tetromino
{
  ...
  {    
   ...
   Configuration iConfigUp = new Configuration( 0, 0, 0, 1, 0, 2, 0, 3 );
    Configuration iConfigLeft = new Configuration( 0, 1, 1, 1, 2, 1, 3, 1 );
    Configuration iConfigDown = new Configuration( 0, 0, 0, 1, 0, 2, 0, 3 );
    Configuration iConfigRight = new Configuration( 0, 1, 1, 1, 2, 1, 3, 1 );
    
    //adds configurations
    config.add( iConfigUp );
    config.add( iConfigLeft );
    config.add( iConfigRight );
    config.add( iConfigDown );
