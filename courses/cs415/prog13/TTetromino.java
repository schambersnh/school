/**
 * TTetromino.java
 * Creates a T Tetromino used in the game of Tetris
 * 
 * Stephen Chambers
 * 11/23/10
 */ 
...
public class TTetromino implements Tetromino
{
  ...
  //----------------------------------------------------------------------------
  /**
   * Constructor for the TTeromino class. 
   */
  ...
  {    
    ...
    Configuration tConfigUp = new Configuration( 0, 1, 0, 2, 0, 3, 1, 2 );
    Configuration tConfigLeft = new Configuration( 0, 2, 1, 1, 1, 2, 2, 2 );
    Configuration tConfigRight = new Configuration( 0, 2, 1, 1, 1, 2, 1, 3 );
    Configuration tConfigDown = new Configuration( 0, 2, 1, 2, 1, 3, 2, 2 );
    
    //adds configurations
    config.add( tConfigUp );
    config.add( tConfigLeft );
    config.add( tConfigRight );
    config.add( tConfigDown );
