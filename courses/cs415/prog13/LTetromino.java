/**
 * LTetromino.java
 * Creates a L Tetromino used in the game of Tetris
 * 
 * Stephen Chambers
 * 11/23/10
 */ 
...
public class LTetromino implements Tetromino
{
  ...
  {    
    ...
    Configuration lConfigUp = new Configuration( 0, 0, 0, 1, 0, 2, 1, 0 );
    Configuration lConfigLeft = new Configuration( 0, 0, 0, 1, 1, 1, 2, 1 );
    Configuration lConfigRight = new Configuration( 0, 2, 1, 0, 1, 1, 1, 2 );
    Configuration lConfigDown = new Configuration( 0, 0, 1, 0, 2, 0, 2, 1 );
    
    //adds configurations
    config.add( lConfigUp );
    config.add( lConfigLeft );
    config.add( lConfigRight );
    config.add( lConfigDown );
