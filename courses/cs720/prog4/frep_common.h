...
void find_matches(FILE*, struct machine*, char*, int*, int*, Frep_Info *, int[], int);
char* get_real_path(char*, int);
void print_match(FILE*, char*, int, char*, int, int);
void print_summary(FILE*, char*, int, int, int);
char* get_full_path(char*, char*);
int check_file(char*, int);
void log_system_error(char*, Frep_Info *, int, int);
void log_error(char[], Frep_Info*, int, int);
void process_file(struct machine*, char*, int*, int*, int, Frep_Info *, int[], int);
char* get_cwd();
void process_loop(Frep_Info*, Elem*, char*, char*, int, int, int);
